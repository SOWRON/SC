...
enum BG_WS_ObjectTypes
{
    ...
    BG_WS_OBJECT_DOOR_H_5       = 10,
    BG_WS_OBJECT_DOOR_H_6       = 11,
    BG_WS_OBJECT_A_FLAG         = 12,
    BG_WS_OBJECT_H_FLAG         = 13,
    BG_WS_OBJECT_SPEEDBUFF_1    = 14,
    BG_WS_OBJECT_SPEEDBUFF_2    = 15,
    BG_WS_OBJECT_REGENBUFF_1    = 16,
    BG_WS_OBJECT_REGENBUFF_2    = 17,
    BG_WS_OBJECT_BERSERKBUFF_1  = 18,
    BG_WS_OBJECT_BERSERKBUFF_2  = 19,
    BG_WS_OBJECT_MAX            = 20
};
...
enum BG_WS_ObjectEntry
{
    ...
    BG_OBJECT_DOOR_A_3_WS_ENTRY          = 180322,
    BG_OBJECT_DOOR_A_4_WS_ENTRY          = 180322,
    ...
    BG_OBJECT_DOOR_H_5_WS_ENTRY          = 180322,
    BG_OBJECT_DOOR_H_6_WS_ENTRY          = 180322,
